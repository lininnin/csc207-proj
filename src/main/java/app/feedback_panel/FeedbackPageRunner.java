 ...
 * Uses the builder (which wires its own dependencies) and shows the page.
 */
public class FeedbackPageRunner {
    ...
    private static void createAndShowUi() {
        ...
        // Pass repo to builder
        final FeedbackPageBuilder builder = new FeedbackPageBuilder(repo);
        frame.add(builder.build(), BorderLayout.CENTER);
