...
public class CreateEventView extends JPanel implements PropertyChangeListener, CreateEventViewModelUpdateListener {
    ...
    private final JButton manageCategoryButton = new JButton("Manage");
    private final CategoryGateway categoryGateway; // 注入的依赖
                           ...
                           CategoryGateway categoryGateway)
 {
     ...
     manageCategoryButton.addActionListener(e -> firePropertyChange("openCategoryManagement", null, null));
     ...
     create.addActionListener(evt -> {
         ...
         String selectedCategory = selectedItem != null ? selectedItem.getName() : "";
    ...
    public void onViewModelUpdated() {
        ...
        String currentCategory = state.getCategory();
        for (int i = 0; i < categoryComboBox.getItemCount(); i++) {
            CategoryItem item = categoryComboBox.getItemAt(i);
            if (item.getName().equals(currentCategory)) {
