// File: src/main/java/view/feedback_panel/feedback_entry/FeedbackEntryPanel.java
...
/**
 * Table view of correlation JSON payload used by {@link FeedbackEntryPanel}.
 * Package-private (non-public) so it can live in the same file.
 */
class CorrelationPanel extends JPanel {
    CorrelationPanel(String correlationJson) {
        setLayout(new BorderLayout());
