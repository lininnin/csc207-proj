...
/**
 * Comprehensive test suite for CreateTaskOutputData.
...
class CreateTaskOutputDataTest {
    ...
    void testValidCreation() {
        ...
        // When
        CreateTaskOutputData outputData = new CreateTaskOutputData(taskId, taskName, message);
    ...
    void testImmutability() {
        ...
        String originalMessage = "Task created successfully";
        
        CreateTaskOutputData outputData = new CreateTaskOutputData(originalTaskId, originalTaskName, originalMessage);
    ...
    void testMultipleInstances() {
        // Given
        CreateTaskOutputData outputData1 = new CreateTaskOutputData("task-1", "Task 1", "Message 1");
        CreateTaskOutputData outputData2 = new CreateTaskOutputData("task-2", "Task 2", "Message 2");
    ...
    void testConsistentGetters() {
        // Given
        CreateTaskOutputData outputData = new CreateTaskOutputData("task-123", "Complete report", "Task created successfully");
    ...
    void testDifferentMessageTypes() {
        ...
        CreateTaskOutputData successData = new CreateTaskOutputData("task-1", "Task 1", "Task created successfully");
        assertEquals("Task created successfully", successData.getMessage());

        // Test error message
        CreateTaskOutputData errorData = new CreateTaskOutputData("task-2", "Task 2", "Error: Task creation failed");
        assertEquals("Error: Task creation failed", errorData.getMessage());
    }
    ...
    void testExtremeCombinations() {
        ...
        CreateTaskOutputData combo1 = new CreateTaskOutputData(null, "", "   ");
        ...
        CreateTaskOutputData combo2 = new CreateTaskOutputData("", null, "A");
